...
class Chat(TimestampedModel):
    identifier = models.CharField(primary_key=True, max_length=255, unique=True)  # 'chat_<post_id>_<user1_id>_<user2_id>'
    ...
    @staticmethod
    def generate_identifier(post_id: int, user_ids: list[int]) -> str:
